...
namespace GalgameManager.Views.Control.TokenizingTextBox
{
    ...
    public class TokenizingTextBoxAutomationPeer : ListViewBaseAutomationPeer, IValueProvider
    {
        ...
        /// </summary>
        /// <param name="owner">
        /// The <see cref="TokenizingTextBox" /> that is associated with this <see cref="T:GalgameManager.Views.Control.TokenizingTextBox.TokenizingTextBoxAutomationPeer" />.
        /// </param>
        ...
        private TokenizingTextBox OwningTokenizingTextBox => (Owner as TokenizingTextBox)!;
        ...
        {
            var name = OwningTokenizingTextBox.Name;
