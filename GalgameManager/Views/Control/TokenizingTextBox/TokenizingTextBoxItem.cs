...
public partial class TokenizingTextBoxItem : ListViewItem
{
    ...
    {
        get => (TokenizingTextBox)GetValue(OwnerProperty);
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GalgameManager.Views.Control.TokenizingTextBox.TokenizingTextBoxItem"/> class.
    /// </summary>
